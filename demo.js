...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    main: function() {
      var deck, hand;
      deck = N.Deck$();
      C.JSArray_methods.shuffle$0(deck.cards);
      P.print(deck);
      hand = C.JSArray_methods.sublist$2(deck.cards, 0, 5);
      deck.cards = C.JSArray_methods.sublist$1(deck.cards, 5);
      P.print(hand);
      P.print(deck);
    },
    Deck: {
      "^": "Object;cards",
      Deck$0: function() {
        var ranks, suits, _i, suit, _i0, rank;
        ranks = ["Ace", "One", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten", "King", "Queen", "Joker"];
        suits = ["Diamond", "Hearts", "Clubs", "Spades"];
        for (_i = 0; _i < 4; ++_i) {
          suit = suits[_i];
          for (_i0 = 0; _i0 < 14; ++_i0) {
            rank = ranks[_i0];
            C.JSArray_methods.add$1(this.cards, new N.Card(suit, rank));
          }
        }
      },
      toString$0: function(_) {
        return P.IterableBase_iterableToFullString(this.cards, "[", "]");
      },
      static: {
        Deck$: function() {
          var t1 = new N.Deck(H.setRuntimeTypeInfo([], [N.Card]));
          t1.Deck$0();
          return t1;
        }
      }
    ...
    Card: {
      "^": "Object;suit,rank",
      toString$0: function(_) {
        return H.S(this.rank) + ":" + H.S(this.suit) + "\n";
      }
    }
  }, 1]];
